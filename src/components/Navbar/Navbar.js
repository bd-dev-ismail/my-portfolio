      ...
      <div className="bg-black">
        <div className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between">
            ...
            >
              <span className="ml-2 handText border-b-2 border-yellow-300 text-xl font-bold hover:text-yellow-300 text-white uppercase">
                Md Ismail Hossen
              </span>
            </Link>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <Link
                          ...
                          className="inline-flex items-center"
                        >
                          <span className="ml-2 border-b-2 border-yellow-300 text-xl font-bold tracking-wide text-white uppercase">
                            Md Ismail Hossen
                          </span>
                        </Link>
                      </div>
